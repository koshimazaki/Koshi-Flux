...
Simple video-to-video using Flux2DeforumPipeline.
...
Usage on RunPod:
    python3 klein_v2v_deforum.py --input video.mp4 --mode v2v --prompt "oil painting"
"""
import sys
import os
import argparse
...
def main():
    ...
    log.info("Loading Flux2DeforumPipeline (native BFL SDK)...")
