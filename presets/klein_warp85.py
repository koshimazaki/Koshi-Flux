"""Klein warp85 - Original smooth settings (NO multi-ref)"""
...
with open(out_path.replace(".mp4", ".json"), "w") as f:
    json.dump({"timestamp": datetime.now().isoformat(), "preset": "warp85_simple", "input_video": INPUT_VIDEO, "prompt": PROMPT, "model": "flux.2-klein-4b", "size": SIZE, "steps": STEPS, "seed": SEED, "ema_alpha": EMA_ALPHA, "warp_blend": WARP_BLEND, "post_lab": POST_LAB, "frames": len(frames), "fps": fps}, f, indent=2)
