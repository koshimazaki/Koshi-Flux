...
model_loader = None
try:
    from flux_motion.models import ModelLoader, model_loader
...
try:
    from setups.core.exceptions import ModelLoadingError, FluxModelError
    HAS_EXCEPTIONS = True
except ImportError:
...
class TestMemoryEstimation:
    ...
    @patch("flux_motion.models.model_loader.configs")
...
class TestLoadModelsWithMocks:
    ...
    @patch("flux_motion.models.model_loader.load_flow_model")
    @patch("flux_motion.models.model_loader.load_ae")
    @patch("flux_motion.models.model_loader.load_t5")
    @patch("flux_motion.models.model_loader.load_clip")
    @patch("flux_motion.models.model_loader.configs")
...
class TestTRTFallback:
    ...
    @patch("flux_motion.models.model_loader.TRT_AVAILABLE", False)
    @patch("flux_motion.models.model_loader.load_flow_model")
    @patch("flux_motion.models.model_loader.load_ae")
    @patch("flux_motion.models.model_loader.load_t5")
    @patch("flux_motion.models.model_loader.load_clip")
