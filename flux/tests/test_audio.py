...
try:
    from flux_motion.audio.mapping_config import (
        FeatureMapping,
        MappingConfig,
        CurveType,
        apply_curve,
    ...
    from flux_motion.audio.schedule_generator import (
        ParseqKeyframe,
        ParseqSchedule,
        ScheduleGenerator,
    )
    from flux_motion.audio.extractor import AudioFeatures
...
pytestmark = pytest.mark.skipif(
    ...
    reason="flux_motion.audio module not available"
)
