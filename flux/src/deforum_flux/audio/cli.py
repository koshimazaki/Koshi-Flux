...
Usage:
    ...
    python -m deforum_flux.audio.cli music.mp3 -o schedule.json

    # Use a specific mapping preset
    python -m deforum_flux.audio.cli music.mp3 -m bass_pulse -o schedule.json

    # List available presets
    python -m deforum_flux.audio.cli --list-presets

    # Generate with custom settings
    python -m deforum_flux.audio.cli music.mp3 -m spectrum --fps 30 --duration 60
"""
...
Examples:
  ...
  python -m deforum_flux.audio.cli music.mp3 --fps 30 --duration 60 -o schedule.json

  # Save features for later use
  python -m deforum_flux.audio.cli music.mp3 --save-features features.json

  # Generate Deforum keyframe strings
  python -m deforum_flux.audio.cli music.mp3 -m spectrum --format deforum
