"""
FLUX Deforum Bridge - Unified Entry Point
...
from deforum_flux.pipeline import FluxVersion, create_pipeline
...
class FluxDeforumBridge:
    ...
    def __init__(self, config: Any, mock_mode: bool = False):
        ...
        Args:
            config: Config instance from deforum.config.settings
        ...
        logger.info(f"FluxDeforumBridge initialized: model={config.model_name}, device={config.device}")
