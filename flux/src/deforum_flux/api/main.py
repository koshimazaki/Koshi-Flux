...
Provides REST API for video generation with FluxDeforumBridge integration.
"""
...
from deforum_flux.api.models.responses import HealthResponse
...
app = FastAPI(
    ...
    version="1.0.0",
    description="REST API for Deforum Flux video generation",
    lifespan=lifespan
)
