...
Integrates with FluxDeforumBridge for video generation.
"""
...
from deforum_flux.api.models.requests import (
    GenerationRequest,
    DirectGenerationRequest,
)
from deforum_flux.api.models.responses import (
    GenerationResponse,
    StatusResponse,
    ValidationResponse,
)
...
async def process_generation(job_id: str, config: Dict[str, Any]):
    ...
    try:
        ...
        bridge = FluxDeforumBridge(bridge_config)
